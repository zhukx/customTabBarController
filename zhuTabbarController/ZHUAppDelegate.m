...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *viewController3 = [[ZHUFirstViewController alloc] initWithNibName:@"ZHUFirstViewController" bundle:nil];    
    ...
    nav2.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"Discover", @"Discover") 
                                                    image:[UIImage imageNamed:@"tb_discover"]
                                                      tag:1];
    [nav2.tabBarItem setSelectedImg:[UIImage imageNamed:@"tb_discover_highlighted"]];
    ...
    nav3.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"Favorites", @"Favorites") 
                                                    image:[UIImage imageNamed:@"tb_favorites"]
                                                      tag:2];
    [nav3.tabBarItem setSelectedImg:[UIImage imageNamed:@"tb_favorites_highlighted"]];
    
    self.tabBarController = [[ZHUTabBarViewController alloc] init];
